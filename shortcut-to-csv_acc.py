...
# Define the subject of the accounting document
subject = "Business Accounting Spreadsheet"
...
prompt = f"""Generate an accounting spreadsheet for the business "{user_inputs['input_1']}". The spreadsheet should calculate monthly and annual taxes, profit, and loss based on a monthly revenue of {user_inputs['input_2']} and monthly expenses of {user_inputs['input_3']}. The tax rate is {user_inputs['input_4']}%. Include any additional notes: {user_inputs['input_5']}."""
